    ...
    <>
      ...
      <section id="tiers" className="bg-lf-mist">
        <div className="container-page py-14">
          <SectionHeading
            ...
            description="LO Mastery is $249 per month. Loan Factory Alliance is $449 per month and adds more frequent coaching, Breakfast Club, advanced certifications, and deeper accountability."
          />
      ...
      <section className="container-page py-14">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Link href="/member-area/certifications/" className="card hover:shadow-lift">
            <p className="text-xs font-semibold uppercase tracking-wide text-lf-orange">
              Credentials
            </p>
          ...
          <Link href="/member-area/calendar/" className="card hover:shadow-lift">
            <p className="text-xs font-semibold uppercase tracking-wide text-lf-orange">
              Coaching calendar
            </p>
          ...
          <Link href="/member-area/leaderboards/" className="card hover:shadow-lift">
            <p className="text-xs font-semibold uppercase tracking-wide text-lf-orange">
              Recognition
            </p>
