...
const areas = [
  ...
  "Team leader cadence and scorecard placeholders.",
    ...
    <PlatformModulePage module={platformModule}>
      <section className="container-page py-14">
        <SectionHeading
          ...
          description="This page is a visible shell until campaign, recruiting, and content-kit source materials are confirmed."
        />
