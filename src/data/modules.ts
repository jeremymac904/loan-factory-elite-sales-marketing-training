...
export const modules: ModuleSummary[] = [
  {
    ...
    corePromise:
      "By Friday, you have a daily rhythm that creates conversations.",
    audience:
    ...
    agenda: [
      ...
      },
      {
        time: "10 to 18",
        topic:
          "The Loan Factory broker value proposition. The 240+ wholesale lender access language.",
      },
  ...
  },
  {
    ...
    corePromise:
      "You convert more pre quals into pre approvals and more pre approvals into apps.",
  ...
  },
  {
    ...
    title: "301 Referral Partner Growth. Build the Partner Engine.",
    theme: "Referral partner growth",
    corePromise: "You add one productive referral partner per week.",
  ...
  },
  {
    ...
    title: "401 Content and Marketing. Local Authority, Compliant Content.",
    theme: "Content and authority marketing",
    corePromise:
      "You build a credible, findable, broker positive presence in your local market.",
  ...
  },
  {
    ...
    title: "501 Pipeline and Sales Systems. Run the Engine Like a Pro.",
    theme: "Follow up, pipeline, and database discipline",
    corePromise: "You stop losing deals to mess.",
    ...
    behaviorChange:
      "LO retention rate moves from the industry baseline toward 40%+ over 24 months.",
  },
  {
    level: "601",
    slug: "601-elite-execution",
    href: "/601-elite-execution/",
    title: "601 Elite Execution. Build Your Niche, Own Your System.",
    theme: "Elite execution",
    corePromise:
      "You graduate with a written 12 week plan and a working AI stack.",
    ...
    doThisToday: [
      ...
      "Choose one AI workflow to build first and document the inputs and outputs.",
    ],
    outcomes: [
      "Pick one niche and write a 12 week plan.",
      "Run the full AI workflow stack across prep, follow up, content, roleplay, and weekly review.",
    ...
    assignment: [
      ...
      "Submit your AI workflow checklist with at least six active prompts.",
