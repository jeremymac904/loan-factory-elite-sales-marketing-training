...
export const roleLabels: Record<string, string> = {
  ...
  admin: "Admin",
  lo_development_lead: "Coaching Manager",
  lo_development_member: "Coach",
  ...
  // going forward is coaching-manager + coach.
  // See docs/role-model/role-aliases.md.
  lo_development: "Coach",
  training_academy: "Coach Support",
  loan_officer_support: "Coach Support",
  corporate_coach: "Coach",
  corporate_coach_supervisor: "Coach Supervisor",
  lo_mastery_coach: "LO Mastery Coach",
  loan_factory_alliance_coach: "Alliance Coach",
  coaching_director: "Coaching Manager",
  ...
  support_staff: "Coach Support",
  vendor_partner_future: "Vendor Partner",
};

export const roleDashboardHrefs: Record<string, string> = {
  master_admin: "/admin/",
  admin: "/admin/",
  lo_development_lead: "/dashboard/",
  ...
  coaching_director: "/dashboard/",
  marketing: "/resources/",
  team_leader: "/coach-command-center/",
  coaching_member_level_1: "/member-area/",
  coaching_member_level_2: "/member-area/",
  loan_officer: "/",
