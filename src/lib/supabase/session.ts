...
const profileSelect =
  "id,email,full_name,role,department,title,avatar_url,status,phone,secondary_phone,profile_url,team_brand,primary_role,notes,last_sign_in_at,bio,nmls,states_licensed,preferred_language,timezone,coaching_tier,ai_twin_enabled,profile_visibility";
