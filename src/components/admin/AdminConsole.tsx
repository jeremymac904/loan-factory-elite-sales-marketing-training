...
const quickActions = [
  ...
  },
  {
    ...
    description: "Review coaching and program assignment coverage.",
  },
  {
    label: "View as role",
    href: "/admin/view-as",
    description: "Preview the platform as a coaching role.",
  },
  {
...
export const adminToolGroups: AdminToolGroup[] = [
  {
    ...
    tools: [
      ...
      { label: "Coach & Program Assignments", href: "/admin/coach-assignments" },
